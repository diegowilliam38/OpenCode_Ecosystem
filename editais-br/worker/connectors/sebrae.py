"""SebraeConnector — conector para o portal SEBRAE (https://www.sebrae.com.br)."""
...
class SebraeConnector(BaseConnector):
    mode = "http"
    base_url = BASE_URL
        ...
        for link in soup.find_all("a", href=True):
            ...
            if titulo and url and not url.startswith("#"):
                if not url.startswith("http"):
                    url = f"https://www.sebrae.com.br{url}" if url.startswith("/") else f"https://www.sebrae.com.br/{url}"
