#!/usr/bin/env bash
# Hook: PostToolUse — Auto-formata arquivo após edições
# Recebe JSON via stdin: {"tool_name": "Edit|Write", "tool_input": {"file_path": "..."}}
# Detecta o formatador disponível baseado na extensão do arquivo
