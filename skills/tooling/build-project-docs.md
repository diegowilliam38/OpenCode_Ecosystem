...
description: Build Project Docs — Geração automática de documentação a partir do código. Source: opencode-skills-main
version: 1.0.0
author: ecosystem
category: tooling
...
# Build Project Docs — Geração automática de documentação a partir do código. Source: opencode-skills-main
