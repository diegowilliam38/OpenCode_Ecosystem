...
---
name: log-analyzer
description: Log Analyzer — Análise automática de logs com pré-processamento. Source: opencode-skills-main
version: 1.0.0
author: ecosystem
category: tooling
...
# Log Analyzer — Análise automática de logs com pré-processamento. Source: opencode-skills-main
