...
---
name: browser-use
description: Install: `pip install browser-use && browser-use install`
version: 1.0.0
author: ecosystem
category: tooling
...
Install: `pip install browser-use && browser-use install`
More: https://github.com/browser-use/browser-use
