...
description: These skills are loaded dynamically when relevant. Mention what you need and the skill activates automatically.
version: 1.0.0
author: ecosystem
category: tooling
...
These skills are loaded dynamically when relevant. Mention what you need and the skill activates automatically.

For more: https://github.com/anthropics/skills
