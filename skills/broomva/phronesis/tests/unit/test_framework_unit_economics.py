"""Unit Economics framework — Phase-1 B.10 instantiation."""
...
@pytest.fixture
def fw() -> Framework:
    return load_framework(FRAMEWORKS_ROOT / "roi" / "unit-economics.yaml")


class TestUnitEconomicsFramework:
    def test_loads_and_validates(self, fw: Framework):
        assert fw.id == "unit-economics"
    ...
    def test_appears_in_load_all(self):
        ...
        assert "unit-economics" in load_all()
