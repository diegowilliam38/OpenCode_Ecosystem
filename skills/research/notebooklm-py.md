...
# Beyond Web UI
Batch downloads, quiz/flashcard export (JSON/Markdown/HTML), mind map JSON extraction, slide PPTX download, slide revision, report template customization

More: https://github.com/teng-lin/notebooklm-py
