...
---
name: qualis-a1-paper-generator
description: Artigos Gerados
version: 1.0.0
author: ecosystem
category: research
...
# Qualis A1 Paper Generator

# Artigos Gerados
- `QML_Medical_Imaging_Qualis_A1.md` (451 linhas, completo)
- `qml_qualis_a1_article.md` (126 linhas, versão concisa)

Autor: Marcelo Claro Laranjeira | Quantum Nexus Research Laboratory
