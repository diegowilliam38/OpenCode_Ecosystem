...
---
name: quantum-dashboard-react
description: - `qml-router.ts` — Rotas da API QML
version: 1.0.0
author: ecosystem
category: research
...
# APIs
- `qml-router.ts` — Rotas da API QML
- `qml-db.ts` — Conexão com banco de dados
- `database.ts` — Schema e queries
- `websocket.ts` — WebSocket para dados em tempo real
- `useWebSocket.ts` — Hook React para WebSocket
