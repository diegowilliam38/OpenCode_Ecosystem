...
---
name: deep-research
description: 1. Busca fontes relevantes (web, documentação, papers)
version: 1.0.0
author: ecosystem
category: research
...
# Fluxo
1. Busca fontes relevantes (web, documentação, papers)
2. Extrai e organiza informações
3. Formata documento com referências e citações
4. Exporta em Markdown ou DOCX

Source: opencode-skills-main/deep-research
