...
description: Android: Android Studio → CPU Profiler
version: 1.0.0
author: ecosystem
category: frontend
...
Install via Claude Code: `/plugin marketplace add callstackincubator/agent-skills`
More: https://github.com/callstackincubator/agent-skills
