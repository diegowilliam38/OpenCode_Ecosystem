...
description: Report Issues By Severity
version: 1.0.0
author: ecosystem
...
- **Critical:** Blocks merge (missing feature, broken test)
- **Important:** Should fix (poor naming, missing edge case)
- **Nice-to-have:** Optional (style preference, minor refactor)
