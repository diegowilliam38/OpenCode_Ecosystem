...
```mermaid
flowchart TB
subgraph INTERFACE["INTERFACE (CLI / Plugin)"]
CLI["Comandos Slash\n/evolve /reversa /plan\n/artigo /quantum"]
end
subgraph ORQUESTRACAO["ORQUESTRACAO (Nexus L0-L6)"]
L0["L0: Meta-Coordenacao\n5 barreiras sincronizacao"]
L1["L1: Domain Discovery\n15 barreiras"]
L2["L2: Autonomous Reasoning\n20 barreiras, 38 subtipos"]
L3["L3: MCP Organization\n25 barreiras"]
L4["L4: Specialization\n30 barreiras"]
L5["L5: Self-Healing\n40 barreiras"]
L6["L6: Feedback & Evolution\n120 feedback points"]
L0 --> L1 --> L2 --> L3 --> L4 --> L5 --> L6
end
subgraph PIPELINES["PIPELINES DE pesquisa"]
SEEKER["SEEKER\n12 agentes\n31 scripts Python"]
ARTIGO["Criador Artigo\n49 agentes\n98 arquivos template"]
QUANTUM["Quantum Nexus\n26 scripts\n50-qubit MPS"]
EDITAIS["editais-br\n52 editais\n3 scripts Python"]
end
subgraph INFRA["INFRAESTRUTURA"]
MCP["17 MCPs\n(11 local, 6 nuvem)"]
PLUGINS["2 Plugins TS\n(ecosystem-sync\nmanus-evolve)"]
SKILLS["23 Skills\n(9 nativas + 14 cc)"]
AGENTES["58 Agentes\ndefinidos em.md"]
end
subgraph EVOLUCAO["EVOLUCAO AUTO-CURA"]
SCANNER["Ecosystem Scanner\nManifest JSON"]
HEALER["Self-Healer\nAnomalias fixadas"]
ENGINE["Evolution Engine\nConhecimento acumulado"]
SCANNER --> HEALER --> ENGINE
end
INTERFACE --> ORQUESTRACAO
ORQUESTRACAO --> PIPELINES
PIPELINES --> INFRA
INFRA --> EVOLUCAO
...
U->>CLI: Comando (/evolve, /artigo)
CLI->>PLUG: Roteia comando
PLUG->>AG: Invoca agente
AG->>MCP: Consulta ferramenta
MCP-->>AG: Resultado
AG->>NEX: Valida (120+ barreiras)
NEX-->>AG: Aprovado
AG-->>PLUG: Resultado final
PLUG-->>CLI: Saida processada
CLI-->>U: Resposta PT-BR
Note over AG,NEX: ptbr_corrector.py aplicado
```
...
```mermaid
flowchart LR
subgraph L0["L0 - Meta-Coordenacao"]
S0["Sessao & Permissoes"]
B0["5 barreiras sincronizacao"]
M0["Mandato Qualis A1"]
end
subgraph L1["L1 - Domain Discovery"]
D1["Extracao de Conceitos"]
SR["Skill Registry"]
CC["Context Compressor"]
B1["15 barreiras sincronizacao"]
end
subgraph L2["L2 - Autonomous Reasoning"]
R2["38 subtipos raciocinio"]
B2["20 barreiras sincronizacao"]
end
subgraph L3["L3 - MCP Organization"]
M3["Auto-Organizacao MCPs"]
SS["Subagent Spawner"]
FS["FSM Protocol"]
WI["Worktree Isolator"]
B3["25 barreiras sincronizacao"]
end
subgraph L4["L4 - Specialization"]
S4["Capacidades Emergentes"]
B4["30 barreiras sincronizacao"]
end
subgraph L5["L5 - Self-Healing"]
SH5["Monitoramento"]
EB["Event Bus"]
BE["Background Executor"]
B5["40 barreiras sincronizacao"]
end
subgraph L6["L6 - Feedback & Evolution"]
F6["120 feedback points"]
SB["simulação Banca"]
B6["Meta-aprendizado"]
end
L0 --> L1 --> L2 --> L3 --> L4 --> L5 --> L6
...
```mermaid
flowchart TB
subgraph RESEARCH["Skills de pesquisa"]
EB["editais-br\n2.5KB\nBusca inteligente de fomento"]
DPE["docling-pdf-extraction\n2.5KB\nExtracao de PDFs"]
AEA["academic-export-abnt\nExportacao ABNT"]
AMP["academic-ml-pipeline\nPipeline ML academico"]
end
subgraph SYSTEM["Skills de Sistema"]
CP["code-philosophy\n618B\n5 Leis Defesa Elegante"]
CR["code-review\n1.3KB\nMetodologia revisao"]
PR["plan-review\n1.2KB\nCriterios planos"]
RO["reasoning-orchestrator\n2.0KB\n58 tipos raciocinio"]
TE["token-efficiency\n1.0KB\nOtimizacao tokens"]
EM["evo-10-mcpick-integration\nIntegracao MCPick"]
end
subgraph FRONTEND["Skills de Frontend"]
FP["frontend-philosophy\n639B\n5 Pilares UI"]
end
subgraph WORKFLOWS["Skills de Workflow"]
PP["plan-protocol\n1.5KB\nPlanos com citacao"]
end
RESEARCH --> SYSTEM
SYSTEM --> FRONTEND
...
```mermaid
flowchart LR
subgraph CC["CC-Skills (14)"]
CE["chrome-extension\n19.4KB"]
HF["humaniseur-fr\n26.3KB"]
IN["influence-negotiation\n28.9KB"]
SPD["skill-progressive-disclosure\n17.5KB"]
DR["deep-research\n13.2KB"]
SG["substack-ghostwriting\n16.0KB"]
TAW["technical-article-writer\n11.2KB"]
TR["training-report\n11.2KB"]
CX["crxjs\n10.9KB"]
SAS["snyk-agent-scan\n8.4KB"]
CG["conventional-git\n7.6KB"]
PRW["press-release-writer\n7.3KB"]
PCL["promql-cli\n5.8KB"]
LG["linkedin-ghostwriting\n5.4KB"]
end
```
...
```mermaid
flowchart TB
subgraph CORE["Agentes Core (18)"]
OA["openagent\n31.4KB\nAgente geral"]
OC["opencoder\n24.4KB\nCodificacao"]
TM["task-manager\n29.3KB\nGerenciamento"]
SM["story-mapper\n24.1KB\nMapeamento"]
CM["context-manager\n16.4KB\nContexto"]
CRET["context-retriever\n19.6KB\nRecuperacao"]
...
CL["codebase-locator\n4.2KB\nLocalizacao"]
CPF["codebase-pattern-finder\n6.2KB\nPadroes"]
CD["coder-agent\n10.4KB\nProgramacao"]
ES["externalscout\n13.2KB\nExploracao externa"]
end
subgraph REVERSA["Agentes Reversa (10)"]
RV["reversa\n4.4KB"]
RARC["reversa-archaeologist\n2.4KB"]
RAR["reversa-architect\n2.2KB"]
RDM["reversa-data-master\n2.4KB"]
RDS["reversa-design-system\n2.3KB"]
RDET["reversa-detective\n2.0KB"]
RRV["reversa-reviewer\n2.1KB"]
RSC["reversa-scout\n2.2KB"]
RVS["reversa-visor\n2.2KB"]
RWR["reversa-writer\n2.7KB"]
end
subgraph WORKSHOP["Agentes Workshop (7)"]
WSCOD["ws-coder\n5.5KB"]
WSRES["ws-researcher\n7.1KB"]
WSRV["ws-reviewer\n4.2KB"]
WSSC["ws-scribe\n3.8KB"]
WDEV["web-developer\n523B"]
WSR["web-search-researcher\n5.3KB"]
FS["frontend-specialist\n7.5KB"]
end
subgraph SPECIALIZED["Agentes Especializados (16)"]
CRV["code-reviewer\n869B"]
DBG["debugger\n856B"]
DOCW["docs-writer\n942B"]
DOC["documentation\n5.5KB"]
...
TW["technical-writer\n1.9KB"]
CPW["copywriter\n1.9KB"]
GIS["image-specialist\n3.1KB"]
LC["linguistic-corrector\n4.3KB"]
AEV["autoevolve\n2.1KB"]
QNP["quantum-nexus-phd\n2.7KB"]
RVW["reviewer\n5.3KB"]
SR["simple-responder\n1.1KB"]
CS["contextscout\n5.7KB"]
end
subgraph MANAGEMENT["Agentes de Gestao (7)"]
GM["git-manager\n991B"]
DM["devops-specialist\n6.1KB"]
ER["eval-runner\n1.2KB"]
...
```mermaid
flowchart TB
subgraph SEARCH["Busca (4)"]
WS["websearch\nDuckDuckGo\nNuvem"]
GH["gh_grep\nGitHub Search\nNuvem"]
C7["context7\nDocumentacao\nNuvem"]
SH["scihub\nArtigos Academicos\nNuvem"]
end
subgraph NAV["Navegador (2)"]
PW["playwright\nAutomacao Browser\nLocal"]
CD["chrome-devtools\nInspecao DOM\nLocal"]
end
subgraph CODE["Codigo (3)"]
ES["eslint\nLinting\nLocal"]
DIFF["diff\nDiferencas\nLocal"]
CR["code-runner\nExecucao Codigo\nLocal"]
end
subgraph DATA["Dados (4)"]
SQL["sqlite\nBanco Local\nLocal"]
FET["fetch\nRequisicoes HTTP\nNuvem"]
PDF["pdf\nManipulacao PDF\nLocal"]
TIM["time\nData/Hora\nLocal"]
end
subgraph REASON["Raciocinio (2)"]
ST["sequential-thinking\nCadeia de Pensamento\nLocal"]
MEM["memory (supermemory)\nMemoria Persistente\nLocal"]
end
subgraph INFRA["Infraestrutura (2)"]
FS["filesystem\nSistema Arquivos\nLocal"]
GHUB["github\nAPI GitHub\nNuvem"]
end
SEARCH --> NAV --> CODE --> DATA --> REASON --> INFRA
```
...
```mermaid
flowchart LR
subgraph AF["Top 7 Conexoes por Afinidade"]
SH_ART["scihub <--> Criador Artigo\n0.95"]
ST_CR["sequential-thinking <--> code-reviewer\n0.90"]
CR_QN["code-runner <--> Quantum Nexus\n0.90"]
EB_WS["editais-br <--> websearch\n0.90"]
AS_SG["academic_search <--> SEEKER-grounder\n0.85"]
EB_DP["editais-br <--> docling-pdf\n0.85"]
WS_SS["websearch <--> SEEKER-searcher\n0.85"]
end
```
...
```mermaid
flowchart TB
subgraph PLUGIN["ecosystem-sync.ts — 463 linhas"]
I0["3 Interfaces\nComponentHealth\nTokenEfficiencyState\nEcosystemState"]
F0["6 Funcoes\nscoreToStatus\nlogObservability\nloadState\nsaveState\ncomputeCrossValidation\ndetectConflicts\ncomputeOverallHealth"]
H0["5 Plugin Hooks\nsession.created\ntool.execute.before\ntool.execute.after\nsession.error\nsession.idle\nshell.env"]
end
subgraph PIPELINE["PIPELINE DE VALIDACAO CRUZADA"]
VAL["VALIDATE\nLeitura opencode.json\nEscaneia MCPs config\nEscaneia agents/*.md\nEscaneia plugins\nRegistra ptbr_corrector"]
CC["CROSS-CHECK\nMatriz MCP<->Agente\nMatriz Plugin<->Agente\nMatriz Corrector<->Agente\nMatriz Token<->todos\n4 pares overlap detectados"]
CORR["CORRECT\nscoreToStatus()\nDegradacao auto\nAlerta critical<70\nAlerta attention<85"]
SC["SCORE\nMedia ponderada comp\nPenalidade: -2/conflito\nBonus: +0.01/entry(max10)\nToken: +3 CJK+2 hdr+2 ctx"]
SY["SYNC\necosystem-state.json\nobservability.jsonl\n25+ ECOSYSTEM_* vars"]
EV["EVOLVE\nhealth_score global\nversion bump 3.5.x\nToken efficiency counter"]
end
subgraph MATRIX["MATRIZ DE AFINIDADE (172 conexoes)"]
M1["code-reviewer <-> eslint/diff: 0.85"]
M2["debugger <-> playwright/chrome: 0.80"]
M3["data-master <-> sqlite/time: 0.75"]
M4["scout <-> filesystem/github: 0.90"]
M5["linguistic <-> pdf/fetch: 0.80"]
M6["qualis <-> pdf/seq-thinking: 0.90"]
M7["token-eff <-> corrector: 0.95"]
M8["writer/editor/qualis: 0.95"]
end
I0 --> F0 --> H0 --> PIPELINE
PIPELINE --> MATRIX
```
...
sequenceDiagram
participant CLI as CLI
participant ES as ecosystem-sync
participant FS as filesystem
participant MCR as MCP Registry
participant AG as Agent Dir
participant LO as Observability Log

CLI->>ES: session.created
ES->>FS: read opencode.json
FS-->>ES: config (MCPs, plugins)
ES->>AG: scan agents/*.md
AG-->>ES: agent list
ES->>MCR: register ptbr_corrector
ES->>ES: computeCrossValidation()
ES->>ES: detectConflicts()
ES->>ES: computeOverallHealth()
ES->>FS: save .evolve/ecosystem-state.json
ES->>LO: log ecosystem.sync.complete
ES-->>CLI: health report

CLI->>ES: tool.execute.before
ES->>ES: startTime latency rec

CLI->>ES: tool.execute.after
ES->>ES: compute latency
alt error detected
    ES->>MCR: degrade score -5
    ES->>LO: log tool error
else success
    ES->>MCR: improve score +1
end

CLI->>ES: session.error
ES->>MCR: degrade ALL MCPs -5
ES->>LO: log session.error

CLI->>ES: session.idle
ES->>ES: final health
ES->>LO: log session complete
ES-->>CLI: ECOSYSTEM_* vars (25+)
```
...
```mermaid
flowchart TB
subgraph STRUCT["Arquitetura do Plugin"]
ST_INT["6 Interfaces\nToolMetric, EvolutionRound\nSessionMetrics, NexusReport\nManusState, ToolCallMetrics"]
ST_FUNC["8 Funcoes\nloadState, saveState\nextractPatterns\nextractCorrectionPatterns\nextractTokenPatterns\ngenerateSkill\n+ 6 plugin hooks"]
end
subgraph PMANUS["PIPELINE EVOLUCAO AUTONOMA"]
PLAN["PLAN\nToolCallMetrics\ncurrentPlan da prompt"]
ACT["ACT\ntool.execute.before\ntool.execute.after\nactionCount++"]
CORRECT["CORRECT\nextractCorrectionPatterns\nCJK detection\nPT-BR ortografia\nCleanup tracking"]
REFLECT["REFLECT\nDiversidade tools\nPadroes identificados\nScore computation"]
EXTRACT["EXTRACT\nsuccess_flow\ntool_chain\ncategory:debug\ncorrection:cjk/ptbr\ntoken:efficiency"]
EVOLVE["EVOLVE\ngenerateSkill()\nevolution/evo-*.md\nscore+correction+token"]
NEXUS["NEXUS Pipeline\necosystem_scanner.py\nself_healer.py\nevolution_engine.py"]
end
subgraph SESS["Gerenciamento Sessao"]
SMET["SessionMetrics\nID, agent, toolsUsed\ntotalCalls, totalErrors\nerrorRate, healthScore\ndurationMinutes"]
EROUND["EvolutionRound\nround, plan, actions\nreflections, skills\nscore, learnings\ncorrectionsApplied\ntokensSaved"]
TTRACK["Tool Tracking\nToolMetric: calls\nerrors, latency\navgLatency, successRate\nAuto-approve >=3"]
end
subgraph INTEG["Integracoes"]
...
sequenceDiagram
participant CLI as CLI
participant ME as manus-evolve
participant ST as State
participant FS as evolution/
participant NX as Nexus
participant DB as Dashboard

CLI->>ME: session.created
ME->>ST: loadState
ME-->>CLI: Round N | Skills X | Score Y

CLI->>ME: tool.execute.before
ME->>ST: actionCount++
ME->>ST: currentPlan = prompt[0:200]

CLI->>ME: tool.execute.after
ME->>ST: track tool calls/latency
ME->>ST: extractPatterns
ME->>ST: extractCorrectionPatterns
ME->>ST: extractTokenPatterns

CLI->>ME: session.idle
ME->>ME: compute score
Note over ME: score = diversity*15 + skills*10<br/>+ correctionBonus + tokenBonus + 20
ME->>FS: generateSkill()
ME-->>FS: evolution/evo-N-*.md
...
ME->>DB: heartbeat /api/dados
alt offline
    ME->>NX: start_dashboard.ps1
end

ME->>ME: sessionMetrics
ME->>ST: saveState
ME-->>CLI: EVOLUCAO Round N
ME-->>CLI: 12+ MANUS_* vars
```
...
```mermaid
flowchart LR
subgraph ES["ecosystem-sync.ts\nSaude infraestrutura\nMCPs, agents, plugins\nhealth score + alertas\ntoken efficiency\nstate + observability\n25+ ECOSYSTEM_* vars"]
end
subgraph MES["manus-evolve.ts\nEvolucao intelectual\nrodadas PlanAct\nskills evolution/*.md\nsession + tool tracking\nnexus scan->heal->learn\n12+ MANUS_* vars"]
end
subgraph SHARED["Ponto Comum"]
CJK["ptbr_corrector.py\nCJK detection+removal\nToken Efficiency v3.5\nZero saida leakage"]
end
ES -->|"health + conflicts"| MES
MES -->|"evol score + skills"| ES
ES -.-> SHARED
MES -.-> SHARED
```
...
```mermaid
flowchart TB
START["Problema de pesquisa"] --> CM["Concept Mapper\nMapeamento conceitual"]
CM --> B0["Break 0\nConfirmacao temas"]
B0 --> GR["Grounder\nDecomposicao + Arvore argumentos\n837 linhas, 9 funcoes"]
GR --> SOC["Social\nFontes contemporaneas\n1.245 linhas, 8 funcoes"]
SOC --> HIST["Historian\nAuditoria historica\n325 linhas, 3 funcoes"]
HIST --> GAP["Gaper\nMapeamento lacunas\n629 linhas, 6 funcoes"]
GAP --> B1["Break 1\nRevisao fundamentos"]
B1 --> VIS["Vision\nImplicacoes logicas\n202 linhas, 3 funcoes"]
VIS --> TH["Theorist\nPropostas pesquisa\n237 linhas, 3 funcoes"]
TH --> RU["Rude\nAvaliacao adversarial\n154 linhas, 2 funcoes"]
RU --> SYN["Synthesizer\nNarrativa pesquisa\n204 linhas, 2 funcoes"]
SYN --> B2["Break 2\nDefinicao trajetoria"]
B2 --> THK["Thinker\nNovas direcoes\n170 linhas, 2 funcoes"]
THK --> SC["Scribe\nMapa entendimento + Output\n570 linhas, 5 funcoes"]
SC --> END["Relatorio de pesquisa"]
```
...
```mermaid
flowchart LR
subgraph CORE_MOD["Modulos Core SEEKER"]
AT["argument_tree.py\n673 linhas\nArvore argumentos"]
CM2["concept_mapper.py\n813 linhas\n12 funcoes\nExpansao conceitos"]
DB["database.py\n586 linhas\n32 funcoes\nSQLite"]
CTX["context.py\n360 linhas\n17 funcoes\nContexto agente"]
REF["references.py\n611 linhas\n26 funcoes\nReferencias"]
CMC["consensus_mcp.py\n459 linhas\n3 funcoes\nConsenso"]
LLM["llm.py\n321 linhas\n2 funcoes\nIntegracao LLM"]
KEY["keys.py\n138 linhas\n15 funcoes\nChaves/.env"]
RL["rate_limiter.py\n217 linhas\n2 funcoes\nRate limiting"]
end
...
participant EH as editais_hook.py
participant ES as edital_search.py
participant PDF as extracao_profunda.py
APP->>EH: buscar_editais("ia saude", tipo="pesquisa")
EH->>ES: REST / HTTP request
ES-->>EH: Resultados + scoring 0-100
EH->>EH: Classificar resultados
EH-->>APP: Lista editais ranqueada
APP->>EH: extrair_edital("edital.pdf")
EH->>PDF: pdfplumber (primario)
alt PDF Falha
EH->>PDF: docling OCR (fallback)
end
PDF-->>EH: Requisitos extraidos
EH-->>APP: Dados estruturados
```
...
```mermaid
flowchart TB
subgraph AGENTES["49 Agentes Especialistas"]
A00["00: Editor-Chefe PhD"]
A01_04["01-04: Diagnostico\nBusca, Evidencias\nEstrutura"]
A05_10["05-10: Literatura\nMetodologia, Estatistica\nVisualizacao, Resultados\nDiscussao"]
A11_16["11-16: conclusão\nBibliografia, QA\nConsistencia, Resumo\nIntegracao"]
A17_22["17-22: Framework\nDados, Auditoria\nEstatistica Avancada\nMatematica, ML/DL"]
A23_28["23-28: Bioinfo, Quimioinfo\nCiencias Sociais, Visao\nComputacional, Quantica\nBenchmarking"]
A29_34["29-34: Conformidade\nTraducao, Peer Review\nEtica, Multi-Norma\nSimilaridade"]
A35_38["35-38: Coleta Dados\nLaTeX/PDF, Slides\nEntrega Final"]
A39_44["39-44: Multi-Paradigma\nMarcos Teoricos, GIS\nDesenvolvedor, Bioinfo\nCorrecao"]
end
subgraph PIPELINE["Pipeline de produção"]
DISP["Dispatcher"]
HO["Handoff entre agentes"]
TEMP["Template TSAC\n87 palavras anti-AI"]
end
subgraph QUALIDADE["Controle de Qualidade"]
ASQ["auto_score_qualis.py\n209 linhas\n10 criterios"]
PTC["ptbr_corrector.py\n359 linhas\nCJK detection + PT-BR"]
end
subgraph EXPORT["Formatos de Saida"]
LAT["LaTeX"]
PDF["PDF"]
DOCX["DOCX ABNT"]
end
AGENTES --> DISP --> HO --> TEMP
TEMP --> ASQ --> PTC --> EXPORT
ASQ -.->|"Score < 95"| HO
```
...
```mermaid
flowchart TB
START["Rascunho Inicial"] --> REV["5 Revisores\nAnalise"]
REV --> CONS["4 Doutores\nConsenso"]
CONS --> CORR["6 Motores de correção\niterative_correction_loop.py\n649 linhas"]
CORR --> ASQ2["auto_score_qualis.py"]
ASQ2 --> DEC{Score >= 95?}
DEC -->|"Sim"| PTC2["ptbr_corrector.py\nCJK -> PT-BR"]
DEC -->|"não"| REV
PTC2 --> EXP["Artigo Final\nQualis A1"]
```
...
```mermaid
flowchart TB
subgraph QUANTUM["Quantum Nexus PhD (26 scripts)"]
MSTR["quantum_nexus_maestro.py\nOrquestrador principal"]
MCTR["quantum_master_controller.py\nControle global"]
subgraph QML["QML Medico"]
HAM["ham10000_integration.py\nDataset real HAM10000\n89.52% acuracia"]
QC["quantum_classifier.py\nClassificador quantico\n50 qubits MPS"]
GC["generate_professional_grad_cam.py\nInterpretabilidade"]
end
subgraph EM["Error Mitigation"]
ZNE["zne_qiskit_implementation.py"]
PEC["pec_pennylane_implementation.py"]
HZB["hybrid_zne_pec.py"]
QBS["qubit_stabilization.py"]
end
subgraph VAL["validação"]
AV["advanced_validation.py"]
QBENCH["qml_scientific_benchmarking.py"]
QUT["quantum_unit_tests.py"]
end
subgraph INFRA["Infraestrutura"]
VQC["vqc_50qubits_training.py"]
QP["quantum_processor.rs\nRust"]
QE["quantum_embeddings.py"]
QA["quantum_applications.py"]
end
subgraph RESEARCH["Research"]
ACD["academic_search.py\nBusca academica"]
SCD["scihub_downloader.py\nDownload artigos"]
FA["phd_forensic_auditor.py\nAuditoria"]
end
subgraph UTILS["Utils"]
MN["main_menu.py"]
LR["learning_roadmap.py"]
BENCH["benchmarking.py"]
end
end
MSTR --> MCTR
MCTR --> QML
...
ESCAN["ecosystem_scanner.py\nScanner autonomo\nManifest JSON"]
EVENG["evolution_engine.py\nAnalise tendencias\nProjecao health"]
SH["self_healer.py\nAuto-cura: CJK\nfrontmatter, syntax"]
end
subgraph META["Meta-Orquestracao"]
MO["meta_orchestrator.py\nCamadas L0-L6"]
MLE["meta_learning_engine.py\nAprendizado entre ciclos"]
ARF["autonomous_reasoning_framework.py"]
MRT["micro_reasoning_types.py\n38 tipos raciocinio"]
end
subgraph SYNC["Sincronizacao"]
MSB["micro_sync_barriers.py\n120+ barreiras"]
MV["micro_validation.py\n500+ constraints"]
MFL["micro_feedback_loop.py\n120 feedback points"]
GSB["git_sync_barrier.py"]
end
subgraph MCP_LAYER["Camada MCP"]
MCPR["mcp_router.py\nRoteamento"]
MCPA["mcp_real_adapters.py\nAdaptadores"]
MCPO["mcp_self_organization.py\nAuto-organizacao"]
AOP["aop_service_discovery.py\nDescoberta"]
end
subgraph AGT["Agentes"]
AM["agent_metamorphosis.py\nMetamorfose"]
ASB["auto_swarm_builder.py\nSwarm automático"]
DDE["domain_discovery_engine.py\nDescoberta dominios"]
end
subgraph INTEG["integração"]
EB2["ecosystem_bridge.py\nPonte ecossistema"]
NI["nexus_integration.py\nIntegracao Nexus"]
MEB["manus_evolve_bridge.py\nPonte Manus Evolve"]
GS["granular_sync.py\nSincronizacao granular"]
end
subgraph PDF_CTX["PDF/Contexto"]
PCO["pdf_context_offload.py"]
PEI["pdf_ecosystem_integration.py"]
CO["context_offload.py"]
end
subgraph TESTS["Testes"]
VS["validation_suite.py\nSuite validação"]
TEF["test_ecosystem_full.py\nTeste completo"]
TMC["test_module_coverage.py\nCobertura modulos"]
end
ECO --> META --> SYNC --> MCP_LAYER --> AGT
META --> INTEG
SYNC --> PDF_CTX
MCP_LAYER --> TESTS
```
...
```mermaid
sequenceDiagram
participant SC as Ecosystem Scanner
participant SH2 as Self-Healer
participant EE as Evolution Engine
participant MV2 as Micro Validation
SC->>SC: Scan: skills, scripts, plugins
SC->>SC: rglob(SKILL.md)
SC->>SC: parse_imports()
SC->>MV2: barrier SB1.1
MV2-->>SC: validated
SC->>SC: Manifest JSON
SC-->>SH2: anomalias detectadas
SH2->>SH2: CJK detection (16 Unicode ranges)
SH2->>SH2: Frontmatter check
SH2->>SH2: Syntax check (MD5 cache)
SH2->>SH2: Size check (< 2.5KB)
SH2-->>EE: anomalias corrigidas
EE->>EE: análise tendencias
EE->>EE: Sugestoes priorizadas
EE->>EE: projeção health score
EE->>EE: Conhecimento em evolution_knowledge.json
EE-->>SC: Proximo ciclo
```
...
subgraph PROCESS["Pipeline de Processamento"]
CLF["Classificador\n25 sub-dimensoes\n12 areas, 4 perfis"]
SCORE["Scoring 0-100\nQuery-aware"]
CACHE["Cache Versionado\nv7.1"]
end
subgraph FEEDBACK["Feedback Loop"]
FB["Feedback SQLite\n--feedback flag"]
TR["Treinamento\n--treinar flag"]
WEIGHT["Peso aprendido\npor dimensao"]
end
...
```mermaid
flowchart LR
subgraph SCORE_COMP["Componentes do Score (0-100)"]
QR["Query Relevance\n0-30 pontos"]
TA["Tipo Alignment\n0-30 pontos"]
PA["Perfil Alignment\n0-20 pontos"]
MB["Mechanism Bonus\n0-10 pontos"]
...
```mermaid
flowchart TB
IA["ia"] --- SAUDE["saude"] --- BIOT["biotec"] --- ENER["energia"]
ENER --- AGRO["agro"] --- EDUC["educação"] --- SOC["social"]
SOC --- CULT["cultura"] --- TECH["tech"] --- ENG["engenharia"]
ENG --- AMB["ambiente"] --- CP["ciencia_pura"]
```
...
```mermaid
flowchart TB
subgraph FAP["16 FAPs Estaduais"]
FAP_SP["FAPESP - SP"]
FAP_RJ["FAPERJ - RJ"]
FAP_MG["FAPEMIG - MG"]
FAP_RS["FAPERGS - RS"]
...
subgraph NACIONAL["Nacionais"]
CNPQ["CNPq"]
CAPES["CAPES"]
FINEP["FINEP"]
end
subgraph EXTERIOR["Internacionais"]
EU["Uniao Europeia\nHorizon Europe"]
USA["EUA\nNSF/NIH"]
UK["Reino Unido\nUKRI"]
JP["Japao\nJSPS"]
end
subgraph SETORIAL["Setoriais"]
BNDES["BNDES"]
EMBRAPII["EMBRAPII"]
SEBRAE["SEBRAE"]
FAPC["Lei do Bem\nIncentivo Fiscal"]
...
```mermaid
flowchart TB
subgraph PHASE1["Fase 1: Scanner"]
SC2["Ecosystem Scanner"]
MD5["Cache MD5"]
IMP["Parse imports"]
HP["Health analysis\nfrontmatter, CJK, size"]
end
subgraph PHASE2["Fase 2: Healer"]
SH3["Self-Healer v2.0"]
CJK["CJK Leaks\nRemove Unicode CJK\n16 ranges"]
FM["Frontmatter\nInsere YAML ---"]
OV["Oversize\nAlerta >2.5KB"]
SYN["Syntax\nErro compilacao Python"]
end
subgraph PHASE3["Fase 3: Evolution"]
EE2["Evolution Engine"]
TREND["análise tendencias\nmelhoria/regressao"]
PATTERN["Padroes sucesso\npadroes falha"]
SUG["Sugestoes\nalta/media/baixa"]
PROJ["projeção health\nfuturo"]
end
PHASE1 --> PHASE2 --> PHASE3
PHASE3 -->|"evolution_knowledge.json"| PHASE1
```
...
```mermaid
flowchart LR
subgraph DASH["Dashboard (porta 8081)"]
END_GET["GET /\nHTML interativo"]
END_API["GET /api/dados\nJSON ecossistema"]
END_SCAN["GET /api/scan\nExecuta scan"]
end
subgraph DATA["Dados Expostos"]
STATS["Stats Cards\nskills, scripts, plugins\nagentes, linhas, anomalias"]
EVO["Rounds Evolucao\nManus Evolve"]
NEX["Relatorios Nexus\nscan -> heal -> learn"]
HIST["histórico Snapshots\nBarras tendencia"]
REC["Recomendacoes\nScanner"]
MES["Status Manus\nEvolve"]
end
DASH --> DATA
...
```mermaid
flowchart LR
subgraph HIST_EVO["histórico de Ciclos"]
C1["Ciclo 1\nEducacao r=-0.03\nP&D r=+0.73\nScore: 85"]
C2["Ciclo 2\nServicos alta tecnologia\nr=+0.95\nScore: 90"]
C3["Ciclo 3\nTSAC, 46 citacoes\nauditaveis\nScore: 92"]
C4["Ciclo 4\nLoop correção\niterativa v2.0\nScore: 95"]
C5["Ciclo 5\nCorrecao CJK\nPT-BR\nScore: 98"]
C6["Ciclo 6\neditais-br v2.0\n4 categorias\nDuckDuckGo real\nScore: 92"]
...
CTX["Contexto em Chines\n40% maior densidade\ninformacional"]
end
subgraph PROCESS["Processamento Interno"]
TOK["Tokenizacao\ndeepseek-v4-pro 200K ctx"]
REAS["Raciocinio\nCadeia de pensamento"]
GEN["geração\nModelo processa"]
end
subgraph CORR["correção Obrigatoria"]
PTC3["ptbr_corrector.py\n359 linhas\n16 Unicode CJK ranges"]
CJK_DET["Deteccao CJK\nU+4E00-U+9FFF\nU+3400-U+4DBF\nentre outros"]
REMOVE["Remocao\nSubstituicao"]
PTBR["correção PT-BR\nGramatica\nOrtografia"]
end
subgraph OUTPUT2["Saida Final"]
RES["Resposta PT-BR Formal\nZero CJK"]
end
CTX --> TOK --> REAS --> GEN
GEN --> CJK_DET --> REMOVE --> PTBR --> RES
CJK_DET -.->|"CJK detectado"| REMOVE
CJK_DET -.->|"Zero CJK"| PTBR
```
...
```mermaid
flowchart TB
subgraph CMDS["Comandos Disponiveis"]
EVO["/evolve\nautoevolve + ecosystem-sync\ndescobre e instala"]
REV["/reversa\nreversa-* agents\nfilesystem + diff + github"]
PLN["/plan\nwriting-plans\nsequential-thinking"]
AUTO["/auto\nopenagent\ntodos MCPs"]
QTM["/quantum\nquantum-nexus-phd\ncode-runner + pdf + seq-thinking"]
ART["/artigo\nSEEKER + Criador Artigo\nmanus-evolve -> Qualis A1"]
end
```
